...
const config = {
    serverInfo: {
        ...
        serverName: "CBA", /*Server name*/
        serverIp: "CBA OFFICIAL", /*Server IP (if you want to add online user counter, you must have true the enable-status and enable-query of server.properties)*/
        discordServerID: "1119713798350180414" /*Your server ID (if you want to add online user counter, you must have enabled Discord server widget)*/
    },
...
const getDiscordOnlineUsers = async () => {
    try {
        ...
        const apiWidgetUrl = `https://discord.com/api/guilds/1119713798350180414/widget.json`;
